...
class SubmissionCore extends AuthenticatedApiBase
{
    ...
    public function completeSubmission(Models\Center $center, Carbon $reportingDate, array $data)
    {
        ...
        try {
            ...
            $this->submitTeamAccountabilities($center, $reportingDate, $reportNow, $teamMembers);
    ...
    protected function submitTeamAccountabilities(Models\Center $center, Carbon $reportingDate, Carbon $reportNow, $teamMembers)
    {
        ...
        foreach ($teamMembers as $k => $tm) {
            ...
            if ($tm->id > 0 && count($tm->accountabilities)) {
                if (($personId = array_get($tm->meta, 'personId', null)) !== null) {
                    $person = Models\Person::findOrFail($personId);
                } else {
                    $person = Models\TeamMember::findOrFail($tm->id)->person;
                }
